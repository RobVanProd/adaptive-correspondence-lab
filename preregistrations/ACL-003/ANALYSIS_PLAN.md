...
- ACL-002 manifest: numeric novelty reference only, never an outcome source.
...
Abort before analysis for SHA/worktree/output/lock/registry/novelty/oracle failure. Never
repair, filter, or rerun after the first outcome artifact exists.
